...
<li> Lines 44-57, we take input from the user with the help of a textfield, pass it to wit and retrieve the JSON (similar to a dictionary in Python). The Json looks like this:</li> </ul>
